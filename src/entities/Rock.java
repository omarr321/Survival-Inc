...
/*
 * Rock is a naturally occuring entity in maps. Can be stored in Inventory.
 * 
 * @author Omar Radwan
 */
public class Rock extends Entity {

	public final String ENTITY_TYPE = "Rock";
	private int layer = 0;
	 ...
	 */
	public Rock(Map containedMap, int x, int y) {
