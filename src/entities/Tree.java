...
/*
 * Trees are naturally occuring in maps. Can be used to craft wood based entities.
 * 
 * @author Wyatt Phillips
 */
public class Tree extends Entity {

	public final String ENTITY_TYPE = "Tree";
	private int layer = 0;
	 ...
	 */
	public Tree(Map containedMap, int x, int y) {
