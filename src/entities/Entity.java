...
public abstract class Entity {
	...
	/*
	 * Constructor. Spawns the entity to the contained map's default spawn.
	 * 
	 * @param containedMap The map to spawn the Entity into.
	 */
	...
	/*
	 * Changes what map contains this entity. The containedMap variable is changed
	 * allowing the entity to interact with the right map's methods.
	 * 
	 * Note that the entity is removed from the previous map to avoid entity
	 * duplication or entity super position.
	 * 
	...
	/*
	 * Sets the position of the entity in accordance with the binded map's
	...
	/*
	 * Set's the object's position to the spawn point. Otherwise, attempt to go to
	...
	/*
	 * Sets the visibility of player to map. This also hides the physical existence
	 * which prevents collisions and interactions with other entities.
	 * 
